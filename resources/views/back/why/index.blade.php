            ...
            <div class="card">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h3 class="card-title pl-2">Why Choose Us</h3>
                        {{Form::open(['method'=>'post','route'=>'choose.store','enctype'=>'multipart/form-data'])}}
                  <div class="card-body">
                            ...
                            <tbody>
                             @foreach($chooses as $choose)
                                 ...
                                 <tr>
                                     ...
                                     <th><img src="{{asset('uploads/'.$choose->submenu)}}" height="50" width="80"></th>
                                     <th>
                                         <a href="{{route('choose.edit',$choose->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                         <a href="{{route('choose.delete',$choose->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
