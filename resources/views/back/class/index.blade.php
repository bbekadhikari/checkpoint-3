                            ...
                            <tbody>
                             @foreach($grades as $choose)
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         <a href="{{route('classes.edit',$choose->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                         <a href="{{route('classes.delete',$choose->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
