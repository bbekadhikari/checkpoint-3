                            ...
                            <tbody>
                              @foreach($subcats as $sub)
                                  <tr>
                                      ...
                                      <td>{{$sub->slug}}</td>
                                      <td>
                                          <a href="{{route('subcategory.edit',$sub->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                          <a href="{{route('subcategory.delete',$sub->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                      </td>
                                  </tr>
                                  @endforeach
                            </tbody>
