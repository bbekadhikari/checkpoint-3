...
<div class="main-wrapper">
     ...
     <header class="header-area">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="top-info-right">
                            ...
                            <div class="top-social">
                                <ul>
                                    <li><a href="facebook.com/index.html"><i class="zmdi zmdi-facebook"></i></a></li>
      ...
      <div class="container-fluid" style="background-image: url('assets/images/slider/background-image-4.jpg'); background-attachment:scroll; background-repeat:no-repeat; background-position: center; background-size: cover; min-height: 200px; width: 100%;">
        <div class="container">
        <h3 class="p-5" style="font-weight:bold; color: white;">STUDY IN USA</h3>
         </div> 
      </div>
              ...
              <div class="col-lg-9">
                  ...
                  <div class="tab-content" id="v-pills-tabContent">
                      <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                          ...
                          <img src="assets/images/slider/background-image-4.jpg">
...
<!-- Mirrored from demo.hasthemes.com/eduhas-preview/eduhas/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Aug 2020 02:52:35 GMT -->
</html>